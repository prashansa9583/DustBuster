...
@section('title','Supervisor Registration')
@section('content')

<section class="home-section" style="background-color:#F2F6F8; padding:30px 30px;">
<link rel="stylesheet" href="css/responsive.css">
    <br>
    <br>
    <br>
    <div class="container">
        <div class="title">SUPERVISOR REGISTRATION</div>
        <div class="content">
            <form class="form" method="post" action="supervisor_submit">
                <br/>
                @csrf
