...
<body>
  ...
  <div data-aos="zoom-out" class=" container ">
    <div class="blueBg">
      <div class="box signin" style="background: #fdf8e6;">
        <h2 style="color: #77664c;">Already have an Account ?</h2>
        <button class="signinBtn" style="border-radius: 18px;">Sign in</button>
      </div>
      <div class="box signup"style="background: #fdf8e6;">
        <h2 style="color: #77664c;">Want to Read More about us?</h2>
    ...
    <div class="formBx">
      ...
      @endif
        <form method="post" action="check">
          ...
          <a href="#" class="forgot" style="color: black;">Forgot Password</a>
        </form>
      </div>  
      ...
      <div class="form signupForm">
        ...
        <form method="post" action="create"> 
          @csrf
          <h3 style="margin-top: 6px; color: black"> WELCOME TO OUR FAMILY </h3>
          ...
          <div class="someText">
            <div class = "text">
            Regular and deep cleaning of city transport buses, on a daily basis to ensure their safe operation and to provide an acceptable level of service and cleanliness to the riding public.
            </div>
          </div>
          <style>
              /* mouse over link */
  ...
  <footer  class="text-gray-600 body-font content" >
    ...
    <div class="bg-gray-100" >
      ...
      style="background: #23252B;">

        <p class="text-m text-gray-500 sm:ml-20 sm:mt-0 mt-4" style="color: white;">©️ 2022 Driven By Data</p>
          <style>
            a:hover{
              color: black;
            }
          </style>
          <a  href="#" class="text-gray-600 ml-1" target="_blank"></a>
        </p>
