...
@section('title','Edit Manager Details')
@section('content') 
...
<br>
    ...
    <br>
    <div class="container">
        <div class="title">EDIT MANAGER DETAILS</div>
        <div class="content">
            <form class="form" method="post" action="{{route('manager.update',[$managerArr[0]->id])}}">
                @csrf
                <div class="user-details">

                    <div class="input-box">
                        <span class="details">Username</span>
                        <input type="text" name="username" class="input" value="{{ $managerArr[0]->username }}"
                    ...
                    <div class="input-box">
                        ...
                        <input type="number" name="phone" class="input" value="{{ $managerArr[0]->phone }}"
                    ...
                    <div class="input-box">
                        ...
                        <input type="email" name="email" class="input" value="{{  $managerArr[0]->email }}"
